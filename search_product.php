...
<body><nav class='navbar navbar-expand-lg nav '>
...
<div class="col-md-10" id="card-container">
 ...
 <?php 
    ...
    if(isset($_GET['search_data_product'])){
       ...
       $select_product="SELECT *FROM products WHERE product_keyword like '%$search_data_value%'";
       ...
       $row_count=mysqli_num_rows($query);
        ...
        if($row_count==0){
            echo "<h2 class='text-center text-danger'>No result match. search item not found  in our store!</h2>";
        }
       ...
       while($product=mysqli_fetch_assoc($query)){
         ...
         <div class='card-body'>
          ...
          <div class='product-price'>
           ...
           <button  class='btn btn-info' >Added Cart</button>
