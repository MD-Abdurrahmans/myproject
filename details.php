...
if(isset($_SESSION['u_name'])){
   echo " <p class='mx-4' >Wellcome guest <a href='user/include/logout.php' class='nav-link btn btn-outline-light '>logout</a> </p>";

}else{

 echo " <p class='mx-4'>Wellcome guest <a href='user/include/login.php' class='nav-link btn btn-outline-light  '>Login</a> </p>";
...
<div class="col-md-10" id="card-container">
 ...
 <?php 
    ...
    while($product=mysqli_fetch_assoc($query)){
        ...
        echo " <div class='col-md-4 col-sm-6 mb-4 raj-card'>
        <div class='card shadow' >
        <div class='d-flex justify-content-start'>
        <img src='admin/upload/$product_image1' class='card-img-top' alt='...'>
        <img src='admin/upload/$product_image2' class='card-img-top' alt='...'>
        <img src='admin/upload/$product_image3' class='card-img-top' alt='...'>
     
       
        </div>
      <div class='card-body'>
        <h5 class='card-title'>$product_name</h5>
        <p class='card-text'><h5 class='u' >Product sumary</h5> <br> $product_summary.</p><br>
        <p class='card-text'><h5 class='u' >Product details</h5> <br>  $product_content.</p>
