...
// include common function
  ...
  if(!isset($_SESSION['u_name'])){
    ...
    header("Location:user/include/login.php");
     ...
     echo "<script>window.open('user/include/payment.php','_self');</script>";
  }
?>
...
<head>
    ...
    <title>Food Website Checkout page</title>
...
<div class="container-fluid m-5">
 ...
 <h2 class="text-center text-info">YOUR CHOICE IS HERE</h2>
